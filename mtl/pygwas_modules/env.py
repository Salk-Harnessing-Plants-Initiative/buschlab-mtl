...
Changed for better use in cluster scripts
...
results_dir = os.getenv("gwas_results_dir")+"/"
#data_dir = '/projects/genotype-callmethods/'
data_dir = os.getenv("GWASPIPELINE_CM_DIR")+"/" # this is set by the module environement
rf_dir = None
env = dict()
...
env['script_dir'] = os.getenv("GWASPIPELINE_SCRIPT_DIR")+"/" # set by the module environment
...
# reading from config file disabled
#try:
#	import configobj
#	try:
